...
func TestAsEvent(t *testing.T) {
	...
	events := []event.CalEvent{
		...
		yerushalmi.NewYerushalmiYomiEvent(hd, dafyomi.Daf{
			Name:  "Terumot",
			Blatt: 22,
		},
			yerushalmi.Vilna,
		),
		dafyomi.NewDafYomiEvent(hd, dafyomi.Daf{
			Name:  "Yevamot",
			Blatt: 74,
		}),
		mishnayomi.NewMishnaYomiEvent(hd, mishnayomi.MishnaPair{
			mishnayomi.Mishna{Tractate: "Kelim", Chap: 9, Verse: 5},
			mishnayomi.Mishna{Tractate: "Kelim", Chap: 9, Verse: 6},
		}),
		nachyomi.NewNachYomiEvent(hd, dafyomi.Daf{
			Name:  "Malachi",
			Blatt: 1,
		}),
	...
	cases := []struct {
		...
		},
		{
			...
			Want: []string{
				...
				"1970-01-17 - Parashat Bo - Havdalah: 5:31",
				"1970-01-23 - Parashat Beshalach - Candle lighting: 4:34",
				"1970-01-24 - Parashat Beshalach - Havdalah: 5:39",
				...
				"1970-02-07 - Parashat Mishpatim - Havdalah: 5:56",
				"1970-02-13 - Parashat Terumah - Candle lighting: 5:01",
				...
				"1970-02-28 - Parashat Ki Tisa - Havdalah: 6:22",
				"1970-03-06 - Parashat Vayakhel - Candle lighting: 5:28",
				...
				"1970-03-19 - Ta'anit Esther - Fast begins: 4:33",
				"1970-03-19 - Ta'anit Esther - Fast ends: 6:37",
				...
				"1970-04-10 - Parashat Tazria - Candle lighting: 6:10",
				"1970-04-11 - Parashat Tazria - Havdalah: 7:13",
				"1970-04-17 - Parashat Metzora - Candle lighting: 6:18",
				"1970-04-18 - Parashat Metzora - Havdalah: 7:22",
				"1970-04-20 - Ta'anit Bechorot - Fast begins: 3:30",
				"1970-04-20 - Erev Pesach - Finish eating chametz: 9:35",
				"1970-04-20 - Parashat  - Biur Chametz: 10:43", // Hebcal bug: wrong label
				"1970-04-20 - Erev Pesach - Candle lighting: 6:21",
				"1970-04-21 - Pesach I - Candle lighting: 7:26",
				...
				"1970-04-27 - Pesach VII - Candle lighting: 8:34",
				...
				"1970-05-09 - Parashat Kedoshim - Havdalah: 8:50",
				"1970-05-15 - Parashat Emor - Candle lighting: 7:49",
				"1970-05-16 - Parashat Emor - Havdalah: 8:59",
				...
				"1970-06-05 - Parashat Bamidbar - Candle lighting: 8:08",
				"1970-06-06 - Parashat Bamidbar - Havdalah: 9:21",
				...
				"1970-06-27 - Parashat Sh'lach - Havdalah: 9:29",
				...
				"1970-07-11 - Parashat Chukat - Havdalah: 9:24",
				"1970-07-17 - Parashat Balak - Candle lighting: 8:09",
				"1970-07-18 - Parashat Balak - Havdalah: 9:18",
				"1970-07-21 - Tzom Tammuz - Fast begins: 3:42",
				"1970-07-21 - Tzom Tammuz - Fast ends: 9:05",
				"1970-07-24 - Parashat Pinchas - Candle lighting: 8:03",
				"1970-07-25 - Parashat Pinchas - Havdalah: 9:11",
				"1970-07-31 - Parashat Matot-Masei - Candle lighting: 7:56",
				"1970-08-01 - Parashat Matot-Masei - Havdalah: 9:02",
				"1970-08-07 - Parashat Devarim - Candle lighting: 7:47",
				"1970-08-08 - Parashat Devarim - Havdalah: 8:52",
				"1970-08-10 - Erev Tish'a B'Av - Fast begins: 8:02",
				"1970-08-11 - Tish'a B'Av - Fast ends: 8:38",
				...
				"1970-08-29 - Parashat Re'eh - Havdalah: 8:16",
				...
				"1970-09-19 - Parashat Ki Tavo - Havdalah: 7:37",
				"1970-09-25 - Parashat Nitzavim-Vayeilech - Candle lighting: 6:26",
				"1970-09-26 - Parashat Nitzavim-Vayeilech - Havdalah: 7:24",
				"1970-09-30 - Erev Rosh Hashana - Candle lighting: 6:17",
				"1970-10-01 - Rosh Hashana 5731 - Candle lighting: 7:15",
				"1970-10-02 - Rosh Hashana II - Candle lighting: 6:13",
				"1970-10-03 - Parashat Ha'azinu - Havdalah: 7:12",
				"1970-10-04 - Tzom Gedaliah - Fast begins: 5:28",
				"1970-10-04 - Tzom Gedaliah - Fast ends: 7:02",
				"1970-10-09 - Erev Yom Kippur - Candle lighting: 6:01",
				"1970-10-10 - Yom Kippur - Havdalah: 7:00",
				"1970-10-14 - Erev Sukkot - Candle lighting: 5:53",
				"1970-10-15 - Sukkot I - Candle lighting: 6:52",
				"1970-10-16 - Sukkot II - Candle lighting: 5:49",
				"1970-10-17 - Parashat  - Havdalah: 6:49",
				"1970-10-21 - Sukkot VII (Hoshana Raba) - Candle lighting: 5:41",
				"1970-10-22 - Shmini Atzeret - Candle lighting: 6:41",
				"1970-10-23 - Simchat Torah - Candle lighting: 5:38",
				"1970-10-24 - Parashat Bereshit - Havdalah: 6:38",
				"1970-10-30 - Parashat Noach - Candle lighting: 4:28",
				"1970-10-31 - Parashat Noach - Havdalah: 5:29",
				"1970-11-06 - Parashat Lech-Lecha - Candle lighting: 4:19",
				"1970-11-07 - Parashat Lech-Lecha - Havdalah: 5:21",
				...
				"1970-11-28 - Parashat Toldot - Havdalah: 5:06",
		...
		},
		{
			...
			Want: []string{
				...
				"1979-12-14 - Parashat Vayeshev - Misheyakir: 6:09",
				...
				"1979-12-14 - Parashat Vayeshev - Tefilah, sof zeman (MGA): 9:51",
				"1979-12-14 - Parashat Vayeshev - Tefilah, sof zeman (GRA): 10:15",
				"1979-12-14 - Parashat Vayeshev - Chatzot HaYom: 11:46",
				"1979-12-14 - Parashat Vayeshev - Mincha Gedolah: 12:08",
		...
		},
		{
			...
			Want: []string{
				"1980-05-21 - Parashat Nasso - Alot HaShachar: 3:34",
				"1980-05-21 - Parashat Nasso - Misheyakir: 4:10",
				...
				"1980-05-21 - Parashat Nasso - Bein HaShemashot: 8:41",
